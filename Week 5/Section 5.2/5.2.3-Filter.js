...
const user6= data.filter(user=>user.userId===6);
console.log(user6);
const user6complete= user6.filter(user=>user.complete===false);
console.log(user6complete);
// filter for tasks with a title less than 24 characters long
const shortTitle=data.filter(user=>user.title.length<24);
